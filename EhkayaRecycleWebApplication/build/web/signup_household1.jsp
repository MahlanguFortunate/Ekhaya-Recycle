...
<head>
    ...
    <title>Recycle Ekhaya - Home User Sign Up</title>
    ...
    <div class="signup-wrapper">
        ...
        <div class="signup-container">
            <div class="signup-box">
                <h2 class="signup-title">Sign Up as Home User</h2>
                ...
                <!-- IMPORTANT: Changed action to RegisterServlet.do -->
                <form class="signup-form" action="RegisterServlet.do" method="POST">
                    <input type="hidden" name="role" value="household_user">
